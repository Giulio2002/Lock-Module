...
exports.resolvers = {
    ...
    GithubResolver: imports_1.resolvers.GithubResolver,
    IPFSResolver: imports_1.resolvers.IPFSResolver,
    SwarmResolver: imports_1.resolvers.SwarmResolver,
};
exports.parsers = {
    UrlParser: core_1.parsers.UrlParser,
    FsParser: fs_1.parsers.FsParser,
    ImportParser: imports_1.parsers.ImportParser,
};
